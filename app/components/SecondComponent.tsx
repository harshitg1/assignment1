  ...
  return (
    <>
        <div className="h-screen w-screen flex flex-col justify-center items-center mt-72----">
            ...
            <h1 className="text-3xl font-semibold mb-6 text-center">Discover our products <span className="text-[#FE8162]">Capabilities</span></h1>
            <p className="text-center">Dont settle for mediocrity - embrace the future of management with Manage Wise.</p>
